...
,{D(jjNUMBER2_OP1),'-',             NUMBER2_CMD,    NUMBER2_CMD   , ALLOW_PLURAL |ALLOW_RING}
...
,{D(jjNUMBER2_OP2),'+',           NUMBER2_CMD,    NUMBER2_CMD,NUMBER2_CMD, ALLOW_PLURAL | ALLOW_RING}
,{D(jjNUMBER2_OP2),'+',           NUMBER2_CMD,    INT_CMD,    NUMBER2_CMD, ALLOW_PLURAL | ALLOW_RING}
,{D(jjNUMBER2_OP2),'+',           NUMBER2_CMD,    NUMBER2_CMD,INT_CMD, ALLOW_PLURAL | ALLOW_RING}
,{D(jjNUMBER2_OP2),'+',           NUMBER2_CMD,    BIGINT_CMD, NUMBER2_CMD, ALLOW_PLURAL | ALLOW_RING}
,{D(jjNUMBER2_OP2),'+',           NUMBER2_CMD,    NUMBER2_CMD,BIGINT_CMD, ALLOW_PLURAL | ALLOW_RING}
...
,{D(jjNUMBER2CR), NUMBER2_CMD,    NUMBER2_CMD,    INT_CMD,    CRING_CMD, ALLOW_PLURAL |ALLOW_RING}
,{D(jjNUMBER2CR), NUMBER2_CMD,    NUMBER2_CMD,    BIGINT_CMD, CRING_CMD, ALLOW_PLURAL |ALLOW_RING}
,{D(jjNUMBER2CR), NUMBER2_CMD,    NUMBER2_CMD,    NUMBER_CMD, CRING_CMD, ALLOW_PLURAL |ALLOW_RING}
,{D(jjNUMBER2CR), NUMBER2_CMD,    NUMBER2_CMD,    NUMBER2_CMD,CRING_CMD, ALLOW_PLURAL |ALLOW_RING}
...
,{D(jjRANDOM_CR),      RANDOM_CMD, NUMBER2_CMD, NUMBER2_CMD, NUMBER2_CMD, CRING_CMD, ALLOW_PLURAL |ALLOW_RING}
...
,{D(jjCALL2ARG),  NUMBER2_CMD,     NUMBER2_CMD,         2      , ALLOW_PLURAL |ALLOW_RING}
...
{  // name-string alias tokval          toktype
  ...
  { "Number",      0, NUMBER2_CMD ,       ROOT_DECL_LIST},
...
,{D(jiA_NUMBER2),  NUMBER2_CMD,    NUMBER2_CMD }
